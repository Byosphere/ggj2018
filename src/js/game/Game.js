class Game extends Phaser.Game {
    ...
    constructor() {
        ...
        this.parameters = {
            ...
            testLevel: { nameKey: 'DEBUG_MODE_LEVEL', hidden: true, value: 0, allValues: null, max: NB_LEVELS, min: 0 },
            herosDebug: { nameKey: 'DEBUG_MODE_HEROS', hidden: true, value: 0, allValues: [{ name: 'Coli', value: COLI_HEROS }, { name: 'Fleur', value: FLEUR_HEROS }] }
        };
